...
_RESPONSE_RULES = (
    ...
    "(e.g., 'I put on a suit', 'I sit down'), those descriptions apply "
    "to THE USER, not to you. Never attribute the user's described "
    "actions or appearance to yourself. Keep clear track of who is "
    "doing what.\n"
